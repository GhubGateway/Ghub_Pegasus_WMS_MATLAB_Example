    ...
    def run(self):
        ...
        try:
            ...
            if (exitCode == 0):
                ...
                print ('launchWrapper.py: hublib.cmd.command.executeCommand(%s) returned with a non zero exit code = %d\n' %(submitcmd, exitCode))
...
if __name__ == '__main__':
    ...
    launchWrapper(parent, tooldir, bindir, datadir, workingdir, rundir, latitude, longitude, maxwalltime)
